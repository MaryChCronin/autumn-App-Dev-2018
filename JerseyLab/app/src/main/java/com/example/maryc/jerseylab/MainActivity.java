...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPlayerName = findViewById(R.id.playerNumber);
        ...
        mJersey = new com.example.maryc.jerseylab.Jersey(name, number, default_colour);
        ChangeJersey();
    ...
    private void ChangeJersey() {
        ...
        mPlayerNumber.setText("" + mJersey.getPlayerNum());
    }
    ...
    protected void onPause() {
        ...
        editor.putInt(KEY_JERSEY_NUMBER, mJersey.getPlayerNum());
    ...
    private void resetJersey() {
        ...
        builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                mJersey = new com.example.maryc.jerseylab.Jersey();
                ChangeJersey();
                SetColour(true);
            }
        });
    ...
    private void editJersey() {
        ...
        numberEditText.setText("" + mJersey.getPlayerNum());
